...
def xmuda(
    ...
    for iteration, data_batch_trg in enumerate(train_dataloader_trg):
        ...
        if cfg.TTA.XMUDA.lambda_xm_trg > 0:
            ...
            loss_2d.append(cfg.TTA.XMUDA.lambda_xm_trg * xm_loss_trg_2d)
            loss_3d.append(cfg.TTA.XMUDA.lambda_xm_trg * xm_loss_trg_3d)
        
        if cfg.TTA.XMUDA.lambda_pl > 0:
            ...
            loss_2d.append(cfg.TTA.XMUDA.lambda_pl * pl_loss_trg_2d)
            loss_3d.append(cfg.TTA.XMUDA.lambda_pl * pl_loss_trg_3d)
