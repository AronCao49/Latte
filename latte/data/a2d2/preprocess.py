...
from latte.data.a2d2 import splits

from latte.data.a2d2.a2d2_dataloader import A2D2Base
...
def preprocess(split_name, root_dir, out_dir):
    ...
    dataloader = DataLoader(DummyDataset(root_dir, split), num_workers=4)
...
if __name__ == '__main__':
    root_dir = '/data1/shared_data/Semantic_Segmentation/a2d2'
    out_dir = '/data1/haozhi/data/a2d2'
    ...
    preprocess('train3', root_dir, out_dir)
    # merge train1 and train2
    data = []
    for curr_split in ['train1', 'train2', 'train3']:
